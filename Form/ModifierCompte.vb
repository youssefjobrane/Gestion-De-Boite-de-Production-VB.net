Public Class ModifierCompte
    ...
    Public Sub New(c As Compte, d As Dash)
        Me.c = c
        Me.d = d
        ...
        GunaTextBox3.Text = c.getSetCin
        GunaTextBox3.Enabled = False
        GunaTextBox4.Text = c.getSetTel
        GunaTextBox5.Text = c.getSetPass

        If (c.getSetSexe = "H") Then
            GunaRadioButton1.Checked = True
        Else
            GunaRadioButton2.Checked = True
        End If

        If (c.getSetType = "Admin") Then
            GunaComboBox1.SelectedIndex = 1
        Else
            GunaComboBox1.SelectedIndex = 2
        End If
        ' Add any initialization after the InitializeComponent() call.

    End Sub
    Private Function test_vide() As Boolean
